...
await expectStatus(await onRequestPost(makeContext({...valid,intent:'external_trade_desk',tradeDirection:'other',productFamily:'other'},undefined,{},'203.0.113.23')),503,'external trade desk intent');
