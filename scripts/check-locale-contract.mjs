...
if((ruHome.match(/<h1\b/g)||[]).length!==1||!ruHome.includes('Из Турции в мир. Из мира — к проверенному производителю.'))errors.push('Russian homepage H1 missing or duplicated');
