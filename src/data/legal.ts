...
Object.assign(termsOfUseCopy as any,{
  ro:{intro:'Acești Termeni de utilizare reglementează accesul la site-ul CTSEG și utilizarea conținutului său corporativ, comercial și informativ.',sections:[['Domeniu și acceptare','Prin utilizarea site-ului acceptați legislația aplicabilă și acești termeni. Conținutul are rol informativ și de evaluare comercială preliminară.'],['Oferte și angajament comercial','Informațiile despre produse, servicii, capacitate, livrare, preț sau piață nu constituie singure o ofertă sau garanție obligatorie. Condițiile se confirmă separat în scris.'],['Furnizori și terți','CTSEG poate evalua informații de la furnizori, producători, cumpărători și alți terți prin metode rezonabile de verificare, fără a garanta automat declarațiile sau performanța terților.'],['Proprietate intelectuală','Marca CTSEG, textele originale, grafica, structurile de raport și metodele sunt protejate și nu pot fi reutilizate comercial fără permisiune scrisă.'],['Utilizare interzisă','Site-ul nu poate fi folosit pentru activități ilegale, identitate sau documente înșelătoare, acces neautorizat, cod malițios sau încălcarea drepturilor terților.'],['Limitarea responsabilității','CTSEG depune eforturi rezonabile pentru corectitudinea și disponibilitatea site-ului, dar nu răspunde pentru decizii luate exclusiv pe baza informațiilor generale sau pentru sisteme terțe în afara controlului său.'],['Modificări și contact','Termenii pot fi actualizați. Întrebările pot fi trimise la info@ctseg.com.tr.']]},
  bg:{intro:'Тези Условия за ползване уреждат достъпа до сайта на CTSEG и използването на корпоративното, търговското и информационното съдържание.',sections:[['Обхват и приемане','С използването на сайта приемате приложимото право и тези условия. Съдържанието е с общ информационен и предварителен търговски характер.'],['Оферти и търговска обвързаност','Информацията за продукти, услуги, капацитет, доставка, цена или пазар сама по себе си не представлява обвързваща оферта или гаранция. Условията се потвърждават отделно писмено.'],['Доставчици и трети страни','CTSEG може да оценява информация от доставчици, производители, купувачи и други трети страни чрез разумни методи за проверка, без автоматично да гарантира техни твърдения или изпълнение.'],['Интелектуална собственост','Марката CTSEG, оригиналните текстове, графики, структури на отчети и методи са защитени и не могат да се използват търговски без писмено разрешение.'],['Забранена употреба','Сайтът не може да се използва за незаконни дейности, подвеждаща самоличност или документи, неоторизиран достъп, злонамерен код или нарушаване на права на трети лица.'],['Ограничаване на отговорността','CTSEG полага разумни усилия за точност и достъпност, но не носи отговорност за решения, основани единствено на обща информация от сайта или за системи на трети страни извън контрола му.'],['Промени и контакт','Условията могат да бъдат актуализирани. Въпроси: info@ctseg.com.tr.']]},
  sr:{intro:'Ovi Uslovi korišćenja uređuju pristup CTSEG sajtu i korišćenje njegovog korporativnog, komercijalnog i informativnog sadržaja.',sections:[['Obim i prihvatanje','Korišćenjem sajta prihvatate primenljivo pravo i ove uslove. Sadržaj služi za opšte informisanje i preliminarnu komercijalnu procenu.'],['Ponude i komercijalna obaveza','Informacije o proizvodima, uslugama, kapacitetu, isporuci, cenama ili tržištu same po sebi nisu obavezujuća ponuda niti garancija. Uslovi se potvrđuju zasebno u pisanom obliku.'],['Dobavljači i treće strane','CTSEG može procenjivati informacije dobavljača, proizvođača, kupaca i drugih trećih strana razumnim metodama provere, bez automatskog garantovanja njihovih izjava ili učinka.'],['Intelektualna svojina','CTSEG brend, originalni tekstovi, grafika, strukture izveštaja i metode zaštićeni su i ne mogu se komercijalno koristiti bez pisane dozvole.'],['Zabranjena upotreba','Sajt se ne sme koristiti za nezakonite aktivnosti, obmanjujući identitet ili dokumentaciju, neovlašćeni pristup, zlonamerni kod ili povredu prava trećih lica.'],['Ograničenje odgovornosti','CTSEG ulaže razumne napore da sadržaj bude tačan i dostupan, ali ne odgovara za odluke zasnovane isključivo na opštim informacijama sajta niti za sisteme trećih strana van njegove kontrole.'],['Izmene i kontakt','Uslovi se mogu ažurirati. Pitanja se mogu poslati na info@ctseg.com.tr.']]}
});
