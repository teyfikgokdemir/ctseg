...
Object.assign(tradeDeskCopy as any,{
  ro:{eyebrow:'CTSEG · BIROU EXTERN DE COMERȚ',title:'Operați un birou extern de comerț internațional cu CTSEG',text:'CTSEG poate funcționa ca echipă externă pentru aprovizionare, dezvoltarea exportului, cercetarea cumpărătorilor și distribuitorilor, urmărirea cererilor de ofertă (RFQ) și coordonare comercială continuă.',cardTitle:'Birou extern de comerț',cardText:'Gestionăm aprovizionarea, dezvoltarea exportului, cercetarea cumpărătorilor și distribuitorilor și urmărirea cererilor de ofertă ca funcție externă.',points:['Abonament lunar pentru sprijin continuu','Aprovizionare, dezvoltarea exportului și urmărirea cumpărătorilor','E-mail al companiei, flux CRM și raportare periodică'],cta:'Discută un birou extern de comerț'},
  bg:{eyebrow:'CTSEG · ВЪНШЕН ТЪРГОВСКИ ОТДЕЛ',title:'Външна функция за международна търговия с CTSEG',text:'CTSEG може да работи като външна търговска функция за снабдяване, развитие на износ, проучване на купувачи и дистрибутори, проследяване на запитвания за оферта (RFQ) и постоянна търговска координация.',cardTitle:'Външен търговски отдел',cardText:'Управляваме снабдяване, развитие на износ, проучване на купувачи и дистрибутори и проследяване на запитванията за оферта.',points:['Месечен абонамент за постоянна поддръжка','Снабдяване, развитие на износ и проследяване на купувачи','Фирмен e-mail, CRM поток и периодични отчети'],cta:'Обсъдете външен търговски отдел'},
  sr:{eyebrow:'CTSEG · SPOLJNOTRGOVINSKO ODELJENJE',title:'Vodite eksternu funkciju međunarodne trgovine uz CTSEG',text:'CTSEG može raditi kao eksterno trgovinsko odeljenje za nabavku, razvoj izvoza, istraživanje kupaca i distributera, praćenje zahteva za ponudu (RFQ) i kontinuiranu komercijalnu koordinaciju.',cardTitle:'Spoljnotrgovinsko odeljenje',cardText:'Vodimo nabavku, razvoj izvoza, istraživanje kupaca i distributera i praćenje zahteva za ponudu kao eksternu trgovinsku funkciju.',points:['Mesečni angažman za kontinuiranu podršku','Nabavka, razvoj izvoza i praćenje kupaca','Kompanijski e-mail, CRM tok i periodično izveštavanje'],cta:'Razgovarajmo o spoljnotrgovinskom odeljenju'}
});
