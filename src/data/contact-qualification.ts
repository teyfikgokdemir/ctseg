...
Object.assign(contactQualification as any,{
  ro:{tradeDirection:'Direcția comerțului',productFamily:'Familia de produse',originMarket:'Țara de origine sau expediere',destinationMarket:'Țara sau piața țintă',packaging:'Ambalare sau format de prezentare',incoterm:'Condiție de livrare / Incoterm',tradeDirections:[{value:'export_from_turkiye',label:'Export din Türkiye'},{value:'import_to_turkiye',label:'Import în Türkiye'},{value:'cross_border_sourcing',label:'Aprovizionare transfrontalieră'},{value:'market_entry',label:'Intrare pe piață și dezvoltare cumpărători'},{value:'other',label:'Altă evaluare comercială'}],productFamilies:[{value:'vegetable_oils',label:'Uleiuri vegetale și alimente'},{value:'nuts_dried_fruit',label:'Nuci și fructe uscate'},{value:'architectural_glass',label:'Sticlă arhitecturală și industrială'},{value:'biofuel_feedstock',label:'Biocombustibili și materii prime energetice'},{value:'other',label:'Alt produs sau serviciu'}]},
  bg:{tradeDirection:'Посока на търговията',productFamily:'Продуктова група',originMarket:'Държава на произход или изпращане',destinationMarket:'Целева държава или пазар',packaging:'Опаковка или формат',incoterm:'Предпочитана доставка / Incoterm',tradeDirections:[{value:'export_from_turkiye',label:'Износ от Türkiye'},{value:'import_to_turkiye',label:'Внос в Türkiye'},{value:'cross_border_sourcing',label:'Трансгранично снабдяване'},{value:'market_entry',label:'Навлизане на пазар и развитие на купувачи'},{value:'other',label:'Друга търговска оценка'}],productFamilies:[{value:'vegetable_oils',label:'Растителни масла и храни'},{value:'nuts_dried_fruit',label:'Ядки и сушени плодове'},{value:'architectural_glass',label:'Архитектурно и индустриално стъкло'},{value:'biofuel_feedstock',label:'Биогорива и енергийни суровини'},{value:'other',label:'Друг продукт или услуга'}]},
  sr:{tradeDirection:'Smer trgovine',productFamily:'Grupa proizvoda',originMarket:'Zemlja porekla ili otpreme',destinationMarket:'Ciljna država ili tržište',packaging:'Pakovanje ili format prezentacije',incoterm:'Željeni uslov isporuke / Incoterm',tradeDirections:[{value:'export_from_turkiye',label:'Izvoz iz Türkiye'},{value:'import_to_turkiye',label:'Uvoz u Türkiye'},{value:'cross_border_sourcing',label:'Prekogranična nabavka'},{value:'market_entry',label:'Ulazak na tržište i razvoj kupaca'},{value:'other',label:'Druga komercijalna procena'}],productFamilies:[{value:'vegetable_oils',label:'Biljna ulja i hrana'},{value:'nuts_dried_fruit',label:'Orašasti plodovi i suvo voće'},{value:'architectural_glass',label:'Arhitektonsko i industrijsko staklo'},{value:'biofuel_feedstock',label:'Biogoriva i energetske sirovine'},{value:'other',label:'Drugi proizvod ili usluga'}]}
});
